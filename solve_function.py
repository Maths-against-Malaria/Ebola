...
def modelEbola(
    ...
    def f(t, pop):
        ...
        #la__ = la(pop=pop, fiso=f_phi_[2], f_tb=f_tb, betaP=betaP, betaIp=betaIp, betaIh=betaIh, betaF=betaF, ph=ph, q=q_, Nerls=Nerls, index=index)
        ...
        la__ = la_aliou2(pop=pop, fiso=f_phi_[2], f_tb=f_tb, betaP=betaP, betaIp=betaIp, betaIh=betaIh, betaF=betaF, ph=ph,
        ...
        # Recovered, Dead
        out[index['R__']] = dR(pop=pop, fdead_p=fdead_p, fdead_h=fdead_h, fdead_i=fdead_i, DI=DI, NIp=NIp, NIh=NIh, NIi=NIi, index=index)
    ...
    np.savetxt("ebola_" + name + ".txt", soln.y)
